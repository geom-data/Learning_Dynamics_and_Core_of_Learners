...
def deepfool_attack(
    ...
    # need to clip this image into the given range (to keep pixels valid (e.g. [0,1] or [-1,1] depending on preprocessing))
    # (1.0 + cfg.overshoot) * r_tot: scale the final perturbation a tiny bit beyond the boundary
